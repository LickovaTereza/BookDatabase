...
<body>
  ...
  <!--book list-->
  <div class="container">
    <h1 class="display-5 mt-4 mb-3">Seznam knih</h1>
    <table class="table">
      <thead>
        <th>Název knihy</th>
        <th>Obálka knihy</th>
      ...
      <tbody>
        <?php foreach ($books as $book) : ?>
          <tr>
            ...
            <td class="col-2">
              <a href="delete.php?id=<?php echo $book->id; ?>" onclick="return confirm('Opravdu chcete smazat?')" class="btn btn-danger btn-sm">odstranit</a>
            </td>
          </tr>
        <?php endforeach ?>
      </tbody>
